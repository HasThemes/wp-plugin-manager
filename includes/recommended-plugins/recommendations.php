 ...
 *
 */
$recommendations = new HTRP_Recommended_Plugins( $text_domain = 'htpm', $parent_menu_slug = 'htpm-options', $submenu_label = '', $submenu_page_name = '', $priority = '', $hook_suffix = 'plugin-manager_page_htpm_extension' );
...
$recommendations->add_new_tab(array(
    ...
    'plugins' => array(
        ...
        array(
            ...
            'image' => WPBFORWPBAKERY_ADDONS_PL_URL . '/assets/images/extensions/wc-builder-pro.png'
        ),
