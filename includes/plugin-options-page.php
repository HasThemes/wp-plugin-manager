...
function htpm_load_posts_cb( $args ){
	...
	?>
  	<div>
	  	...
	  	<div class="htpm_field_desc"><?php echo __('"-1" represents unlimited. <br> Default: 150. Due to the performance reason we set the limit of 150 pages, posts or custom posts to load. Change the amount as your need if you have more than that amount of posts or pages. <br> After changes, click on the <b>"Save Settings"</b> button to you get the options for each plugins below.', 'htpm') ?></div>
  	</div>
	<?php
}
